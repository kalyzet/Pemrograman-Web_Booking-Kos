...
@section('content')
    ...
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        <h1 class="font-bold text-[30px] leading-[45px] text-center">Jelajahi Berbagai<br>Kos Kami</h1>
        <form action="{{ route('find-kos.results') }}"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                <div class="flex flex-col w-full gap-2">
                    <p class="font-semibold">Cari Nama</p>
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91e2eb] transition-all duration-300">
                        ...
                        <input type="text" name="search" id=""
                            ...
                            placeholder="Tipe Nama Kos">
                    </label>
                </div>
                <div class="flex flex-col w-full gap-2">
                    <p class="font-semibold">Cari Wilayah</p>
                    <label
                        class="relative flex items-center w-full rounded-full p-[14px_20px] gap-2 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91e2eb] transition-all duration-300">
                ...
                <div class="flex flex-col w-full gap-2">
                    <p class="font-semibold">Cari Kategori</p>
                    <label
                        class="relative flex items-center w-full rounded-full p-[14px_20px] gap-2 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91e2eb] transition-all duration-300">
                        <img src="assets/images/icons/location.svg"
                            class="absolute w-5 h-5 flex shrink-0 transform -translate-y-1/2 top-1/2 left-5" alt="icon">
                ...
                <button type="submit" class="flex w-full justify-center rounded-full p-[14px_20px] font-bold text-white"
                    style="background-color: rgb(22, 208, 228);">Jelajahi
                    Sekarang</button>
            </div>
        </form>
    </div>
