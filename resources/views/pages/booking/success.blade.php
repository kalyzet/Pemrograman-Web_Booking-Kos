...
@section('content')
    <div id="Background"
        class="absolute top-0 w-full h-[430px] rounded-b-[75px] bg-[linear-gradient(180deg,#e6f6f9_0%,#D2EDE4_100%)]"></div>
    <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
        <h1 class="font-bold text-[30px] leading-[45px] text-center">Booking Sukses<br>Selamat!</h1>
        ...
        <div class="flex flex-col gap-[18px]">
            <p class="font-semibold">ID Booking Milikmu</p>
        ...
        <div class="flex flex-col gap-[14px]">
            <a href="{{ route('home') }}"
                class="w-full rounded-full p-[14px_20px] text-center font-bold text-white bg-ngekos-orange">Jelajahi Kos
                Lain</a>
            <form action="{{ route('check-booking.show') }}"method="POST">
                ...
                <button class="w-full rounded-full p-[14px_20px] text-center font-bold text-white bg-ngekos-black">Lihat
                    Booking Saya</button>
            </form>
        </div>
    </div>
